...
class HomeScreen extends StatelessWidget {
  ...
  static const _cats = [
    ServiceCategory.plomeria, ServiceCategory.electricidad,
    ServiceCategory.carpinteria, ServiceCategory.pintura,
    ServiceCategory.albanileria, ServiceCategory.jardineria,
    ServiceCategory.limpieza, ServiceCategory.cerrajeria,
    ServiceCategory.aires, ServiceCategory.mudanza,
  ];
